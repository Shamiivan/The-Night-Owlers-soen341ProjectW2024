  ...
  return (
    ...
    <div className="flex justify-center items-center h-screen bg-blue-500">
      ...
      <div className="flex flex-col justify-center items-start p-8 mr-4 text-white">
        ...
        <p className="text-lg">At Omni Rental, we provide you with a seamless and convenient way to find the perfect vehicle for your needs. Whether you're planning a road trip, a business journey, or simply need a reliable ride for your daily commute, we've got you covered.</p>
      </div>
      
     
      <div>
        <Image src="/home_page_main.png" alt="Car" width={1900} height={300} />
      </div>
    </div>
