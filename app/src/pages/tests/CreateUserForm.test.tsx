...
describe('CreateUserForm', () => {
  it('renders form and handles submission', async () => {
    ...
    // Wait for the asynchronous operation (e.g., fetch) to complete
    await waitFor(() => {
      // Assert: Check if router.push was called with the expected route
      expect(useRouter().push).toHaveBeenCalledWith('/admin/users');
